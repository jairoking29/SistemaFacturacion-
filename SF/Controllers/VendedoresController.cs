...
namespace SF.Controllers
{
    public class VendedoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_Vendedor,Nombre,PrecioComision,Estado")] Vendedores vendedores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_Vendedor,Nombre,PrecioComision,Estado")] Vendedores vendedores)
        {
            if (ModelState.IsValid)
            {
